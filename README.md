...
> forked from [@omegion1npm/assumenda-minima-vitaeode](https://www.npmjs.com/package/@omegion1npm/assumenda-minima-vitaeode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@omegion1npm/assumenda-minima-vitaeode/issues/300).

[![npm version](https://img.shields.io/npm/v/@omegion1npm/assumenda-minima-vitae.svg)](https://www.npmjs.com/package/@omegion1npm/assumenda-minima-vitae)
[![Downloads](https://img.shields.io/npm/dm/@omegion1npm/assumenda-minima-vitae.svg)](https://www.npmjs.com/package/@omegion1npm/assumenda-minima-vitae)
[![Build Status](https://github.com/omegion1npm/assumenda-minima-vitae/workflows/CI/badge.svg)](https://github.com/omegion1npm/assumenda-minima-vitae/actions)
...
```sh
npm install --save-dev eslint @omegion1npm/assumenda-minima-vitae
```
...
```js
const nodePlugin = require("@omegion1npm/assumenda-minima-vitae")
...
💼 [Configurations](https://github.com/omegion1npm/assumenda-minima-vitae#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/omegion1npm/assumenda-minima-vitae#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/omegion1npm/assumenda-minima-vitae#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/omegion1npm/assumenda-minima-vitae#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/omegion1npm/assumenda-minima-vitae#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/omegion1npm/assumenda-minima-vitae#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/omegion1npm/assumenda-minima-vitae#-configs).\
...
`@omegion1npm/assumenda-minima-vitae` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/omegion1npm/assumenda-minima-vitae/releases)
